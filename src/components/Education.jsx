    ...
    return (
        <div>
            <div className=" h-screen">
                <div className="bg-educationColor font-Gothic text-lg h-36 rounded-md m-auto flex items-center px-10 border border-black">
                    ...
                    return (
                        <div key={key}>
                            <div className=" h-max w-96 bg-heroColor  rounded-xl p-8 border border-black hover:scale-110 transition-border duration-700">
                                ...
                                <div className="">
                                    <button className=" mt-4 rounded-lg bg-black text-white w-full h-14" onClick={() => buy(data)}>
                                        Buy Now
                                    </button>
                                </div>
                            </div>
